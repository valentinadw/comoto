	...
	if ( ! class_exists( 'Yolo_Term_Meta_Install' ) ):
		...
		final class Yolo_Term_Meta_Install {
			...
			public function __construct() {
				...
				// Setup plugin
				$this->file     = PLUGIN_YOLO_MOTOR_FRAMEWORK_FILE;
				$this->url      = PLUGIN_YOLO_MOTOR_FRAMEWORK_URL;
				$this->path     = PLUGIN_YOLO_MOTOR_FRAMEWORK_DIR;
				$this->basename = PLUGIN_YOLO_MOTOR_FRAMEWORK_NAME;
				$this->db       = $wpdb;
