...
<div <?php post_class( $classes ); ?>>
    ...
    <div class="product-item-inner">
        ...
        <div class="product-info">
            ...
            // Remove and return original order
            remove_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_product_title', 10 );
