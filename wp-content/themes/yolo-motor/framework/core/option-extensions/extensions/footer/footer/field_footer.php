    ...
    class ReduxFramework_footer extends ReduxFramework {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                echo '<strong>' . esc_html__( 'No items of this type were found. Please activate Yolo Motor Framework plugin and create footer at Footer Block', 'yolo-motor' ) . '</strong>';
            }
        } //function
