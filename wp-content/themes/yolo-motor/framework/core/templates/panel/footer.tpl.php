...
<div id="redux-footer-sticky">
    <div id="redux-footer">
        ...
        <div class="redux-action_bar">
            ...
            <?php submit_button( esc_html__( 'Save & Generate CSS', 'yolo-motor' ), 'primary redux_generate', $this->parent->args['opt_name'] . '[lesscss]', false ); ?>
            ...
            <?php if ( false === $this->parent->args['hide_reset'] ) : ?>
                <?php submit_button( esc_html__( 'Reset Section', 'yolo-motor' ), 'secondary reset_btn', $this->parent->args['opt_name'] . '[defaults-section]', false, array( 'id' => 'redux-defaults-section' ) ); ?>
                <?php submit_button( esc_html__( 'Reset All', 'yolo-motor' ), 'secondary reset_all_btn', $this->parent->args['opt_name'] . '[defaults]', false, array( 'id' => 'redux-defaults' ) ); ?>
            <?php endif; ?>
