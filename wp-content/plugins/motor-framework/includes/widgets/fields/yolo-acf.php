...
if (!class_exists('yolo_acf_widget_fields')) {
    class yolo_acf_widget_fields {
        ...
        public function enqueue() {
            ...
            wp_enqueue_style('yolo-widget-rows-css', plugins_url() . '/motor-framework/includes/widgets/fields/assets/style.css', array(), false);
            wp_enqueue_script('yolo-widget-rows-js', plugins_url() . '/motor-framework/includes/widgets/fields/assets/main'.$min_suffix.'.js', false, true);
        }
    }
}