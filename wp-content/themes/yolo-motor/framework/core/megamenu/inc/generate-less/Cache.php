<?php
require_once get_template_directory() . '/framework/core/megamenu/inc/generate-less/Version.php';
...
class Less_Cache{
	...
	public static function Cache( &$less_files, $parser_options = array() ){
		...
		$file = get_template_directory() . 'framework/core/megamenu/inc/generate-less/Less.php';
