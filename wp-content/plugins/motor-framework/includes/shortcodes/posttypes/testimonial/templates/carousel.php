...
?>
<div id="yolo-testimonial" class="yolo-testimonial testimonial-carousel">
    ...
    <ul id="testimonial-list-<?php echo $testimonial_id; ?>" class="testimonials testimonial-list owl-carousel owl-theme">
        ...
        <li class="testimonial-item">
            <div class="testimonial-content"><?php echo ($excerpt_length != '') ? yolo_limit_words_pg($post->post_content, $excerpt_length) : the_content(); ?> </div>
            <h3 class="testimonial-title"><?php the_title(); ?></h3>
            <?php if( !empty($testimonial_position) ) : ?>
            <p class="testimonial-position"><?php echo esc_html($testimonial_position['0']); ?></p>
            <?php endif; ?>
            <?php if( !empty($testimonial_special) ) : ?>
            <p class="testimonial-special"><?php echo esc_html($testimonial_special['0']); ?></p>
            <?php endif; ?>
        </li>
        <?php endwhile; ?>
    </ul>
